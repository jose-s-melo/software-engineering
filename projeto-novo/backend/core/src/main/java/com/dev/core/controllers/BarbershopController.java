...
@Tag(name = "Barbearias", description = "Endpoints responsáveis pelo gerenciamento de barbearias")
public class BarbershopController {

    @Autowired private BarbershopService service;
    ...
    @ApiResponses(
            value = {
                @ApiResponse(responseCode = "204", description = "Barbearia removida com sucesso"),
    ...
    public ResponseEntity<Void> updateBarbershop(
            @PathVariable UUID id, @RequestBody BarbershopUpdateDTO body) {
