...
public class AuthController {
    ...
    @Operation(
            ...
            description =
                    "Autentica um usuário utilizando e-mail e senha e retorna um token JWT juntamente com os dados do usuário.")
    ...
    @Operation(
            ...
            description =
                    "Cria uma nova conta. Os usuários são cadastrados com o perfil COMMON por padrão.")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            required = true,
    ...
    @Operation(
            ...
            description =
                    "Permite que o usuário autenticado altere sua senha informando a senha atual e a nova senha.")
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
            required = true,
    ...
    public ResponseEntity<Void> confirmForgotPassword(
            @RequestBody ConfirmForgotPasswordRequestDTO body) {
