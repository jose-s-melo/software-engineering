...
@Tag(
        name = "Autenticação",
        description = "Endpoints referentes a login e registro de usuários"
)
public class AuthController {
    ...
    @Operation(
            ...
            description = "Cria uma nova conta utilizando email e senha. Os usuários por padrão possuem o role COMMON"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "201",
