...
public class AgendamentoService {
    ...
    /**
     * Cria ou atualiza a agenda de um barbeiro para um dia específico. Preenche automaticamente o
     * dia da semana com base na data informada.
     */
    @Transactional
                ...
                .orElseThrow(
                        () ->
                                new RuntimeException(
                                        "Nenhuma agenda disponível para este barbeiro nesta data."));
    }
