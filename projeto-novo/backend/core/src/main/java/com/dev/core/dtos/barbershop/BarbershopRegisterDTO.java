...
public record BarbershopRegisterDTO(
    ...
    @Schema(
        description = "Nome de usuário único da barbearia",
        example = "barbearia-exemplo"
    )
    String username,

    @Schema(
        description = "CPF do proprietário da barbearia.",
    ...
    @Schema(
        description = "Telefone da barbearia para contato",
        example = "(83) 9999-98888"
    )
    String phone
