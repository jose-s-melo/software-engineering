...
public class NotificationController {
    ...
    @Operation(
            ...
            description =
                    "Envia uma notificação por e-mail para um usuário utilizando o endereço de e-mail informado.")
    @ApiResponses(
            value = {
    ...
    public ResponseEntity<Void> sendEmail(@RequestBody SendEmailDTO body) {
